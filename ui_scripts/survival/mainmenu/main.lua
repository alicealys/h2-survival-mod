...
function addmainelements()
    ...
    esc:settextoffset(0, 3)

    local escarea = element:new()
    escarea:setrect(90, 1080 - 95, 130, 47)

    escarea:onnotify("mouseenter", function()
        game:playsound("h1_ui_menu_scroll")
    ...
    escarea:onnotify("mouseleave", function()
        game:playsound("h1_ui_menu_scroll")
    ...
    escarea:onnotify("click", function()
